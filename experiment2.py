...
def setup_logging(log_level=logging.INFO, log_to_file=True):
    ...
    if log_to_file:
        file_handler = logging.FileHandler(f"logs/experiment2_{timestamp}.log")
...
def run_experiment_2():
    ...
    logging.info(f"Starting Experiment 2 with {total_combinations} total model combinations")
    ...
    for dataset_name in DATASETS:
        ...
        data_path = os.path.join(DATA_FOLDER, f"E2_{dataset_name}_{SEED}_data.npz")
        ...
        for scenario in SCENARIOS:
            ...
            for model_name, model_initializer in MODEL_CONFIGS.items():
                ...
                try:
                    ...
                    results_filename = f"E2_{dataset_name}_{scenario}_{model_name}_results.npz"
